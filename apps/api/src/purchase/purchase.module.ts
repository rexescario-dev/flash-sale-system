import { PURCHASE_FLOW, PURCHASE_HISTORY_QUERY, PURCHASE_REPOSITORY } from '@flash-sale/domain';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: PURCHASE_HISTORY_QUERY,
      useExisting: PrismaPurchaseHistoryQuery,
    },
    {
